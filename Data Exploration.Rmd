...
## Analyzing The Number of Thefts {.tabset}
...
From the initial plot of the distribution, the variance did not appear to be constant. In this section, we will explore and interpret a box cox transformation in order to see if we can get better performance.
```{r}
